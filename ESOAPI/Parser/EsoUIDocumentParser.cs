...
public class EsoUIDocumentParser
{
    ...
    public static List<EsoUIArgument> ParseArgs(string args)
    {
        ...
        foreach (string arg in argsArray)
        {
            ...
            data.Add(new EsoUIArgument(match.Groups[2].Value, new EsoUIType(match.Groups[1].Value)));
        }
    ...
    public bool ReadXmlAttributes()
    {
        ...
        Data.XmlAttributes[name] = new EsoUIArgument(name, new EsoUIType(type));
    ...
    public bool ReadXmlLayout()
    {
        switch (true)
        {
            ...
            case true when LineStartsWith("* _attr"):
                ...
                CurrentElement.Attributes.Add(new EsoUIArgument(name, new EsoUIType(type)));
                break;
